      ...
      <div className="flex flex-row items-center gap-2">
        {scales.map((scale) => (
          <button
            key={scale.value}
            className={cn(
              'w-[4em] shrink-0 grow-1 basis-0 cursor-pointer items-center justify-center rounded-md border border-gray-200 bg-gray-50 py-1.5 text-xs text-gray-500 transition-colors hover:bg-gray-100 sm:py-1 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-400 dark:hover:bg-gray-800',
